      ...
      <div id="mf" style={{ position:'relative',minHeight:'100vh',overflowX:'hidden' }}>
        ...
        <div style={{ position:'relative',zIndex:10,maxWidth:640,margin:'0 auto',padding:'52px 14px 48px' }}>
          ...
          <motion.div {...reveal(0.06)} className="mf-contact-strip" style={{ display:'flex',flexWrap:'wrap',justifyContent:'center',gap:8,marginBottom:24 }}>
            {[
              {
                icon: <svg width={13} height={13} viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.7)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>,
                l:'info@mlrit.ac.in'
              },
              {
              ...
              {
                icon: <svg width={13} height={13} viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.7)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81 19.79 19.79 0 01.01 1.18 2 2 0 012 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 14.92z"/></svg>,
                l:'Toll Free: 18005724363'
              },
              {
                icon: <svg width={13} height={13} viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.7)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M22 10v6M2 10l10-9 10 9"/><path d="M6 10v8a1 1 0 001 1h4v-5h2v5h4a1 1 0 001-1v-8"/></svg>,
                l:'NAAC A Grade'
              },
            ].map(x => (
